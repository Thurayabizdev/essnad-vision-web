...
const Footer = () => {
  return (
    <footer className="bg-essnad-gray text-white">
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1: About */}
          <div>
            <h3 className="text-xl font-bold text-essnad-orange mb-4">Essnad</h3>
            ...
            <div className="flex space-x-4 mt-6">
              <a href="#" className="text-white hover:text-essnad-orange" aria-label="Facebook">
                <Facebook size={20} />
              </a>
              <a href="#" className="text-white hover:text-essnad-orange" aria-label="Twitter">
                <Twitter size={20} />
              </a>
              <a href="#" className="text-white hover:text-essnad-orange" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              <a href="#" className="text-white hover:text-essnad-orange" aria-label="Instagram">
                <Instagram size={20} />
              </a>
            </div>
          </div>
